...
중요한 것은 관찰자 목록을 밖에서 변경할 수 있도록 public으로 열어놨다는 점이다. 이를 통ㅅ해 누가 알림을 받을 것인지를 제어할 수 있다. 대상은 관찰자와 상호작용하지만, 디커플링 되어 있다(물리 코드 어디에도 업적 관련 부분은 없지만 업적 시스템에 알림을 보낼 수 있다). 이 것이 바로 관찰자 패턴의 장점이다. 
