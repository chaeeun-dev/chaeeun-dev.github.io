...
<mark style='background-color: #dcffe4'> revert </mark>
...
<mark style='background-color: #dcffe4'> reset </mark>
...
cf) Revert와 Reset을 제대로 할 수 없으면 "이 작업이 잘못되면 다 끝장이야..."이런 생각이 들어 작업에 소극적이게 될 수 있다. 이 작업을 제대로 할 수 있으면 파일 날라가도 다시 되돌릴 수 있으니 쓸 데 없는 걱정이 줄어들게 된다!
...
a.txt에 C D를 추가했었는데, 이전 상태로 파일이 복원되었다는 걸 알 수 있다.

![image](https://github.com/user-attachments/assets/62704366-354a-4ae6-8f62-20456324b59d)


스태시를 통해 두 개, 세 개 이상의 여러 변경 사항을 임시로 저장할 수 있다.
